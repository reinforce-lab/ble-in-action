...
FILE_SEC_LABELS = {
    ...
    # Chapter 3
    "03-ble-layer/3.1-communication-architecture.md": "communication-architecture",
    "03-ble-layer/3.2-throughput.md": "throughput",
    "03-ble-layer/3.3-range-and-reliability.md": "range-and-reliability",
    "03-ble-layer/3.4-connectionless-communication.md": "connectionless-communication",
    "03-ble-layer/3.5-position-and-distance.md": "position-and-distance",
    "03-ble-layer/3.6-isochronous-communication.md": "isochronous-communication",
    "03-ble-layer/3.7-capability-selection.md": "capability-selection",
    "03-ble-layer/3.8-summary.md": "ch3-summary",
    # Chapter 4
